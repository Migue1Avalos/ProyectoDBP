    ...
    public ResponseEntity<List<UsuarioDTO>> getUsuarios() {
        ...
        for (Usuario usuario : usuarios) {
            ...
            if (usuario.getImage_path() != null) {
                usuarioDTO.setImage_path( appConfig.getBackendBaseUrl() + "/usuarios/" + usuario.getId() + "/profile_picture");
            }
            if (usuario.getBackground_picture() != null) {
                usuarioDTO.setBackground_picture(appConfig.getBackendBaseUrl() + "/usuarios/" + usuario.getId() + "/banner_picture");
            }
